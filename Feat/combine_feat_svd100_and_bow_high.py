...
#        ('question2_bow_common_vocabulary_cosine_sim_stats_feat_by_question1_relevance', SimpleTransform()),
        # ('question2_bow_common_vocabulary_cosine_sim_stats_feat_by_question1_cat_relevance', SimpleTransform()),
        ...
        # # ('question2_bow_common_vocabulary_common_svd100_cosine_sim_stats_feat_by_question1_cat_relevance', SimpleTransform()),
        ...
        # # ('question2_bow_common_vocabulary_individual_svd100_cosine_sim_stats_feat_by_question1_cat_relevance', SimpleTransform()),
...
#        ('question2_tfidf_common_vocabulary_cosine_sim_stats_feat_by_question1_relevance', SimpleTransform()),
        # ('question2_tfidf_common_vocabulary_cosine_sim_stats_feat_by_question1_cat_relevance', SimpleTransform()),
        ...
        # ('question2_tfidf_common_vocabulary_common_svd100_cosine_sim_stats_feat_by_question1_cat_relevance', SimpleTransform()),
        ...
        # # ('question2_tfidf_common_vocabulary_individual_svd100_cosine_sim_stats_feat_by_question1_cat_relevance', SimpleTransform()),
