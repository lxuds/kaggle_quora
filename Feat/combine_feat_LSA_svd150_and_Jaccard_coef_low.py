...
__file__
    ...
    combine_feat_[LSA_svd150_and_Jaccard_coef_May19]_[Low].py
...
#        ('description_missing', SimpleTransform()),
        ...
        # ("question2_unigram_jaccard_coef_stats_feat_by_relevance", SimpleTransform()),
        # ("question2_unigram_jaccard_coef_stats_feat_by_question1_relevance", SimpleTransform()),
        # ("question2_bigram_jaccard_coef_stats_feat_by_relevance", SimpleTransform()),
        # ("question2_bigram_jaccard_coef_stats_feat_by_question1_relevance", SimpleTransform()),
        # ("question2_trigram_jaccard_coef_stats_feat_by_relevance", SimpleTransform()),
        # ("question2_trigram_jaccard_coef_stats_feat_by_question1_relevance", SimpleTransform()),

        #  ## dice dist stats feat
        # ("question2_unigram_dice_dist_stats_feat_by_relevance", SimpleTransform()),
        # ("question2_unigram_dice_dist_stats_feat_by_question1_relevance", SimpleTransform()),
        # ("question2_bigram_dice_dist_stats_feat_by_relevance", SimpleTransform()),
        # ("question2_bigram_dice_dist_stats_feat_by_question1_relevance", SimpleTransform()),
        # ("question2_trigram_dice_dist_stats_feat_by_relevance", SimpleTransform()),
        # ("question2_trigram_dice_dist_stats_feat_by_question1_relevance", SimpleTransform()),
...
#        ('question2_tfidf_common_vocabulary_individual_svd150_cosine_sim_stats_feat_by_question1_relevance', SimpleTransform()),
    ...
    if sys.argv[1] == "Testing":
        ...
        combine_feat(feat_names, "LSA_svd150_and_Jaccard_coef_May19", mode, Ntest)
